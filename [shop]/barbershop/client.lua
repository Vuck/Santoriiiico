...
local hair_price            = 25
local hair_color_price      = 15
local beard_price           = 25
local beard_color_price     = 15
local eyebrows_price        = 25
local eyebrows_color_price  = 15
local makeup_price          = 25
local makeup_opacity_price  = 15
local lipstick_price        = 25
local lipstick_color_price  = 15
