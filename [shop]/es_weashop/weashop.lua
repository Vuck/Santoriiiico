local weashop = {
	...
	menu = {
		...
		["Melee"] = {
			...
			name = "Melee",
			buttons = {
				{title = "Knife", name = "Knife", costs = 10000, description = {}, model = "WEAPON_Knife"},
				...
				{title = "Bat", name = "Bat", costs = 7000, description = {}, model = "WEAPON_Bat"},
				-- {title = "Crowbar", name = "Crowbar", costs = 30000, description = {}, model = "WEAPON_Crowbar"},
				{title = "Golfclub", name = "Golfclub", costs = 9000, description = {}, model = "WEAPON_Golfclub"},
				...
				{title = "SwitchBlade", name = "SwitchBlade", costs = 12500, description = {}, model = "WEAPON_SwitchBlade"},
		...
		["Pistolets"] = {
			...
			buttons = {
				...
				{title = "SNS Pistol", name = "SNSPistol", costs = 25000, description = {}, model = "WEAPON_SNSPISTOL"},
				{title = "Heavy Pistol", name = "HeavyPistol", costs = 45000, description = {}, model = "WEAPON_HeavyPistol"},
				...
				{title = "Revolver", name = "Revolver", costs = 70000, description = {}, model = "WEAPON_Revolver"},
				{title = "AP Pistol", name = "APPistol", costs = 91000, description = {}, model = "WEAPON_APPistol"},
				--{title = "Stun Gun", name = "StunGun", costs = 2800, description = {}, model = "WEAPON_StunGun"},
				{title = "Flare Gun", name = "FlareGun", costs = 17500, description = {}, model = "WEAPON_FLAREGUN"},
			}
		},
		-- ["MachineGuns"] = {
			-- title = "Machine guns",
		...
		["AssaultRifles"] = {
			...
			name = "AssaultRifles",
			buttons = {
				--{title = "Assault Rifle", name = "AssaultRifle", costs = 91500, description = {}, model = "WEAPON_ASSAULTRIFLE"},
		...
		-- ["ThrownWeapons"] = {
			...
			-- buttons = {
				...
				--{title = "Molotov", name = "Molotov", costs = 3500, description = {}, model = "WEAPON_Molotov"},
				...
				--{title = "Ball", name = "Ball", costs = 250, description = {}, model = "WEAPON_Ball"},
				--{title = "Snowball", name = "Snowball", costs = 200, description = {}, model = "WEAPON_Snowball"},
