...
AddEventHandler('pecheur:getCar2', function (source)
	...
	AddEventHandler('pecheur:drawGetPoisson', function (qtePoisson)
		...
		if qtePoisson < 90 then
			TriggerEvent('player:receiveItem',21, 2)
			ClearPrints()
			SetTextEntry_2("STRING")
	...
	AddEventHandler('pecheur:drawGetFilet', function(qtePoisson, qteFilet)
		...
		if qteFilet < 90 and qtePoisson > 1 then
			TriggerEvent('player:looseItem',21, 2)
			TriggerEvent('player:receiveItem',22, 2)
			ClearPrints()
			SetTextEntry_2("STRING")
	...
	AddEventHandler('pecheur:drawSellFilet', function (qte)
		...
		if qte > 1 then
			TriggerEvent('player:looseItem',22, 2)
