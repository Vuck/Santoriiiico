...
AddEventHandler('mineur:getCar2', function (source)
	...
	AddEventHandler('mineur:drawGetMinerai', function (qteMinerai)
		...
		if qteMinerai < 90 then
			TriggerEvent('player:receiveItem',1, 2)
			ClearPrints()
			SetTextEntry_2("STRING")
	...
	AddEventHandler('mineur:drawGetMetal', function(qteMinerai, qteMetal)
		...
		if qteMetal < 90 and qteMinerai > 1 then
			TriggerEvent('player:looseItem',1, 2)
			TriggerEvent('player:receiveItem',2, 2)
			ClearPrints()
			SetTextEntry_2("STRING")
	...
	AddEventHandler('mineur:drawSellMetal', function (qte)
		...
		if qte > 1 then
			TriggerEvent('player:looseItem',2, 2)
