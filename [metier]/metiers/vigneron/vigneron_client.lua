...
AddEventHandler('vigneron:getCar', function (source)
	...
	AddEventHandler('vigneron:drawGetRaisin', function (qteVign)
		...
		if qteVign < 90 then
			TriggerEvent('player:receiveItem',vigneron_ressourceBase, 2)
			ClearPrints()
			SetTextEntry_2("STRING")
	...
	AddEventHandler('vigneron:drawGetVin', function(qteVign, qteTraite)
		...
		if qteTraite < 90 and qteVign > 1 then
			TriggerEvent('player:looseItem',vigneron_ressourceBase, 2)
			TriggerEvent('player:receiveItem',vigneron_ressourceTraite, 2)
			ClearPrints()
			SetTextEntry_2("STRING")
	...
	AddEventHandler('vigneron:drawSellVin', function (qte)
		...
		if qte > 1 then
			TriggerEvent('player:looseItem',vigneron_ressourceTraite, 2)
