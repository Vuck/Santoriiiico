...
AddEventHandler('brasseur:getCar', function (source)
	...
	AddEventHandler('brasseur:drawGetOrge', function (qteBase)
		...
		if qteBase < 90 then
			TriggerEvent('player:receiveItem',brasseur_ressourceBase, 2)
			ClearPrints()
			SetTextEntry_2("STRING")
	...
	AddEventHandler('brasseur:drawGetBiere', function(qteBase, qteTraite)
		...
		if qteTraite < 90 and qteBase > 1 then
			TriggerEvent('player:looseItem',brasseur_ressourceBase, 2)
			TriggerEvent('player:receiveItem',brasseur_ressourceTraite, 2)
			ClearPrints()
			SetTextEntry_2("STRING")
	...
	AddEventHandler('brasseur:drawSellBiere', function (qte)
		...
		if qte > 1 then
			TriggerEvent('player:looseItem',brasseur_ressourceTraite, 2)
