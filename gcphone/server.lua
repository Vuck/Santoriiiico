...
AddEventHandler('gcphone:sendMessage', function(phoneNumber, message)
    ...
    local identifier = GetPlayerIdentifiers(source)[1]
    print(identifier)
    addMessage(mysource, identifier, phoneNumber, message)
end)
...
AddEventHandler('gcphone:deleteMessageNumber', function(number)
    ...
    TriggerClientEvent("gcphone:allMessage", mysource, getMessages(identifier))
end)
...
AddEventHandler('gcphone:deleteALL', function()
    ...
    TriggerClientEvent("gcphone:contactList", mysource,{})
    TriggerClientEvent("gcphone:allMessage", mysource,{})
end)
...
-- AddEventHandler('hardcap:playerActivated',function()
	...
	-- local userIsExisting = MySQL.Sync.fetchAll("SELECT COUNT(*) FROM users WHERE identifier = @identifier", {
			-- ['@identifier'] = identifier
		-- })
		
	-- if userIsExisting[1].count == 1 then
		-- while myPhoneNumber == nil or tonumber(myPhoneNumber) == 0 do 
			-- local randomNumberPhone = getPhoneRandomNumber()
			-- print("Num de tel groooooooooooo : "..randomNumberPhone)
