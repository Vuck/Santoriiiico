...
--      {['Title'] = 'Telephone' , ['Event'] = 'phone:toggleMenu'},
        {['Title'] = 'Emote', ['SubMenu'] = {
            ['Title'] = 'Menu',
            ['Items'] = {
                { ['Title'] = 'Bras tendu', ['Function'] = playAminationLoop, ['dictionaries'] = "nm@hands", ['clip'] = 'flail', ['Close'] = false },
				{ ['Title'] = 'Emote loop', ['Function'] = playAminationLoop, ['dictionaries'] = "mini@strip_club@pole_dance@pole_dance2", ['clip'] = 'pd_dance_02',['Close'] = false },
                { ['Title'] = 'Emote non loop',   Function = playAmination ,  dictionaries = "amb@world_human_leaning@male@wall@back@foot_up@base", clip = "base",['Close'] = false },
                { ['Title'] = 'Saluer', ['SubMenu'] = {
                    ...
                    ['Items'] = {
                        ...
                        { ['Title'] = "Salut militaire", Function = playAmination , dictionaries = "mp_player_int_uppersalute", clip = "mp_player_int_salute",['Close'] = false },
                    }
                }},
                { ['Title'] = 'Humeur', ['SubMenu'] = {
                    ...
                    ['Items'] = {
						...
						{ ['Title'] = "Branleur", Function = playAmination ,  dictionaries = "mp_player_int_upperwank", clip = "mp_player_int_wank_01",['Close'] = false },
...
--                      { ['Title'] = 'Mains en l\'air', ['Function'] = playAmination, ['dictionaries'] = "missminuteman_1ig_2", ['clip'] = 'handsup_base' },
                ...
                { ['Title'] = 'Sportives', ['SubMenu'] = {
                    ...
                    ['Items'] = {
                        ...
                        { ['Title'] = "Faire du tennis", Function = playEmote, ['EmoteName'] = "WORLD_HUMAN_TENNIS_PLAYER",['Close'] = false},						
                    }
                }},
                { ['Title'] = 'Festives', ['SubMenu'] = {
                    ['Title'] = 'Animations - Festives',
                    ['Items'] = {
                        { ['Title'] = "Danse Femme",   Function = playAmination ,  dictionaries = "mini@strip_club@private_dance@part1", clip = "priv_dance_p1",['Close'] = false }, -- Danse femme
                        { ['Title'] = "Danser", ['Function'] = playAmination, ['dictionaries'] = "amb@world_human_partying@female@partying_beer@base", ['clip'] = 'base',['Close'] = false }, 
                        { ['Title'] = "Tappes moi en 5", Function = playAmination , dictionaries = "mp_ped_interaction", clip = "highfive_guy_a",['Close'] = false },
                        { ['Title'] = "Boire une biere", Function = playEmote, ['EmoteName'] = "WORLD_HUMAN_DRINKING",['Close'] = false},
						...
						{ ['Title'] = 'Faire une danse ridicule', ['Function'] = playAmination, ['dictionaries'] = "misschinese2_crystalmazemcs1_cs", ['clip'] = 'dance_loop_tao',['Close'] = false },
                    }
                }},
                { ['Title'] = 'Prendre une pose', ['SubMenu'] = {
                    ...
                    ['Items'] = {
						...
						{ ['Title'] = "Contre un mur", Function = playEmote, ['EmoteName'] = "WORLD_HUMAN_LEANING",['Close'] = false},
						...
						{ ['Title'] = "Dormir sur le sol", Function = playEmote, ['EmoteName'] = "WORLD_HUMAN_BUM_SLUMPED",['Close'] = false},
                        { ['Title'] = "Regarder sa carte", Function = playEmote, ['EmoteName'] = "WORLD_HUMAN_TOURIST_MAP",['Close'] = false},
                    }
                }},
                { ['Title'] = 'Autres', ['SubMenu'] = {
                    ...
                    ['Items'] = {
                        ...
                        { ['Title'] = "Crocheter", Function = playEmote, ['EmoteName'] = "WORLD_HUMAN_WELDING",['Close'] = false},
                        { ['Title'] = "Prendre des notes", Function = playEmote, ['EmoteName'] = "WORLD_HUMAN_CLIPBOARD",['Close'] = false},
                        { ['Title'] = "Fumer une clope", Function = playEmote, ['EmoteName'] = "WORLD_HUMAN_SMOKING",['Close'] = false},
                        { ['Title'] = "Fumer un ****", Function = playEmote, ['EmoteName'] = "WORLD_HUMAN_SMOKING_POT",['Close'] = false},
                        { ['Title'] = "Reparer le moteur",   Function = playAmination ,  dictionaries = "amb@world_human_vehicle_mechanic@male@idle_a", clip = "WORLD_HUMAN_VEHICLE_MECHANIC",['Close'] = false },
                        { ['Title'] = "Se gratter les c**", Function = playAmination , dictionaries = "mp_player_int_uppergrab_crotch", clip = "mp_player_int_grab_crotch",['Close'] = false },
                        { ['Title'] = "Rock and Roll", Function = playAmination , dictionaries = "mp_player_int_upperrock", clip = "mp_player_int_rock",['Close'] = false },
                        ...
                        { ['Title'] = "Faire la manche", Function = playEmote, ['EmoteName'] = "WORLD_HUMAN_BUM_FREEWAY",['Close'] = false},
                        { ['Title'] = "Statue humaine", Function = playEmote, ['EmoteName'] = "WORLD_HUMAN_HUMAN_STATUE",['Close'] = false},
                        { ['Title'] = "Sortir un balai", Function = playEmote, ['EmoteName'] = "WORLD_HUMAN_JANITOR",['Close'] = false},
                    }
                }},
                { ['Title'] = 'Metier', ['SubMenu'] = {
                    ...
                    ['Items'] = {
                        ...
                        { ['Title'] = 'Peche', ['Function'] = playEmote, ['EmoteName'] = 'WORLD_HUMAN_STAND_FISHING',['Close'] = false }, -- P?cheur
